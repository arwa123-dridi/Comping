...
public class ReservationController {
    ...
    @GetMapping
    public List<ReservationResponse> getAll() { return service.getAllReservations(); }

    @GetMapping("/{id}")
    public ReservationResponse getById(@PathVariable String id) { return service.getReservationById(id); }
